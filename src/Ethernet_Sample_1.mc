...
void FunctionEthernetHandler(void)
{
    ...
    return;
}//$X {Status,1,1,0,28,0,28,0,(-1),1},0x2000,29,0
//$X {User Parameter (5),1,1,0,-1,0,-1,0,(-1),-1},0x2201,5,0
//$X {CV_2,1,1,0,26,0,26,0,(-1),1},0x2000,27,0
//$X {Recv_data,1,1,0,10,1,2,1,(0,60),1},0x2102,5,0
//$X {Recv_data,1,1,0,10,1,2,1,(2,60),1},0x2102,7,0
//$X {Recv_data,1,1,0,10,1,2,1,(3,60),1},0x2102,8,0
//$X {Recv_data,1,1,0,10,1,2,1,(1,60),1},0x2102,6,0
//$X {array1,1,1,0,9,1,1,1,(0,60),1},0x2101,5,0
//$X {errNo,1,1,0,23,0,23,0,(-1),1},0x2000,24,0
//$X {AX1_Error,1,1,0,21,0,21,0,(-1),1},0x2000,22,0
//$X {AX2_Error,1,1,0,22,0,22,0,(-1),1},0x2000,23,0
