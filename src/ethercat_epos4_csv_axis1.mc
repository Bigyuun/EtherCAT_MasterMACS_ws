...
//	sdkEpos4_SetupECatVirtAmp(C_AXIS1, C_AXIS_MAX_RPM, EPOS4_OP_CSP);
	sdkEpos4_SetupECatVirtAmp(C_AXIS1, C_AXIS_MAX_RPM, EPOS4_OP_CSV);
...
//	AxisControl(C_AXIS1,ON,  C_AXIS2,ON,  C_AXIS3,ON,  C_AXIS4,ON);//,  C_AXIS3,ON,  C_AXIS4,ON,  C_AXIS5,ON,  C_AXIS6,ON,  C_AXIS7,ON
	AxisControl(C_AXIS1,ON);//,  C_AXIS3,ON,  C_AXIS4,ON,  C_AXIS5,ON,  C_AXIS6,ON,  C_AXIS7,ON
...
//	Dec(C_AXIS1, 30, C_AXIS2, 30, C_AXIS3, 30, C_AXIS4, 30);//, C_AXIS2, 30, C_AXIS3, 30, C_AXIS4, 30, C_AXIS4, 30, C_AXIS6, 30, C_AXIS7, 30
	...
	Vel(C_AXIS1, 400);//, C_AXIS2, 40, C_AXIS3, 40, C_AXIS4, 40, C_AXIS5, 40, C_AXIS6, 40, C_AXIS7, 40
	Acc(C_AXIS1, 2000);//, C_AXIS2, 30, C_AXIS3, 30, C_AXIS4, 30, C_AXIS5, 30, C_AXIS6, 30, C_AXIS7, 30
	Dec(C_AXIS1, 2000);//, C_AXIS2, 30, C_AXIS3, 30, C_AXIS4, 30, C_AXIS4, 30, C_AXIS6, 30, C_AXIS7, 30
...
//		AxisPosRelStart( C_AXIS1, 20000, C_AXIS2, 20000,   C_AXIS3, 20000,   C_AXIS4, 20000);//, C_AXIS2, 20000,   C_AXIS3, 20000,   C_AXIS4, 20000,   C_AXIS5, 20000,   C_AXIS6, 20000,   C_AXIS7, 20000
		//AxisPosRelStart( C_AXIS1, 2000);//, C_AXIS2, 20000,   C_AXIS3, 20000,   C_AXIS4, 20000,   C_AXIS5, 20000,   C_AXIS6, 20000,   C_AXIS7, 20000
		AxisCvelStart(C_AXIS1);
//		AxisWaitReached(C_AXIS1,C_AXIS2,C_AXIS3,C_AXIS4);//,C_AXIS2,C_AXIS3,C_AXIS4,C_AXIS5,C_AXIS6,C_AXIS7
		AxisWaitReached(C_AXIS1);//,C_AXIS2,C_AXIS3,C_AXIS4,C_AXIS5,C_AXIS6,C_AXIS7
...
//		AxisPosAbsStart( C_AXIS1, 0, C_AXIS2, 0, C_AXIS3, 0, C_AXIS4, 0);//, C_AXIS2, 0, C_AXIS3, 0, C_AXIS4, 0, C_AXIS5, 0, C_AXIS6, 0, C_AXIS7, 0
		AxisPosAbsStart( C_AXIS1, 0);//, C_AXIS2, 0, C_AXIS3, 0, C_AXIS4, 0, C_AXIS5, 0, C_AXIS6, 0, C_AXIS7, 0
//		AxisWaitReached(C_AXIS1,C_AXIS2,C_AXIS3,C_AXIS4);//,C_AXIS2,C_AXIS3,C_AXIS4,C_AXIS5,C_AXIS6,C_AXIS7
		AxisWaitReached(C_AXIS1);//,C_AXIS2,C_AXIS3,C_AXIS4,C_AXIS5,C_AXIS6,C_AXIS7
...
void EncoderDataupdates(void)
{
	sdkSetupIncEncoder(C_AXIS1, 0, 4096, 0, 0, 0);

    //Delay(1000);

    //print("Position = ", Apos(C_AXIS1));
    print("Position = ", Apos(C_AXIS1));
	print("Velocity = ", Avel(C_AXIS1));
	//double encvalue;
	//encvalue = SdoRead(1000001, 0x6004, 0);
	//print("enc val = ", SdoRead(1000001, 0x6004, 0));
    return;
}
